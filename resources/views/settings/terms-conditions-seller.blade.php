                ...
                <div class="card-body">
                    <div class="row form-group">
                        ...
                        <div class="col-md-12 mt-3">
                            <textarea id="tinymce_editor" name="terms_conditions_seller" class="form-control col-md-7 col-xs-12" aria-label="tinymce_editor">{{ $settings['terms_conditions_seller'] ?? '' }}</textarea>
                        </div>
                    </div>
